...
function [T,Ts,AA,EE,HH,SS]=AntTransferX(ant,op,er,solver,antennalength, diameter,ZL,YL)
...
% solver==2
%
% March 2008: solver==3 -> Concept with patches
