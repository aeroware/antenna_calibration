...
function [Ant,NewO,NewS,NewN,NewP]=GridExtract(Ant0,Objs,Nodes,Segs,Pats)

% [Ant,NewO,NewS,NewN,NewP]=GridExtract(Ant0,Objs,Nodes,Segs,Pats)
...
% elements building the objects Obj are automatically extracted.
% Pass 'all' (or any string) to extract all objects or elements of the 
% respective kind. Pass only Ant0 to extract all objects, segments and 
% patches, which amounts to removing 'unused' nodes. 
%
% NewO, NewN, NewS and NewP are index matrices which give the new 
