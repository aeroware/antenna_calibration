...
% or a cell array of strings of the same length as Nodes. It can also be a 
% numeric array, then it is transformed into strings using num2str. Anno is 
% ooptional, if omitted or empty the node numbers are used for annotation.
...
[PNodes,PSegs,PPats,NH,SH,PH]=PlotRecog(Ant,'N');
