...
% vectors of found node- and segment- and patch-numbers, respectively. 
...
% patches, respectively. The fields Node.Tag, Seg.Tag and Patch.Tag of 
% the global variable PlotGridProp determines if the search is restricted 
% to objects with the corresponding Tag. The UserData property of the 
