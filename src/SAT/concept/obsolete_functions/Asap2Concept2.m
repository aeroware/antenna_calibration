...
function ant=Asap2Concept2(ant);

% ant=Asap2Concept(ant) converts the ant structure of a wiregrid
% into concept friendly format. The input and output parameter is the
% variable ant which holds the wiregrid-structure. The following changes
% are performed on the ant structure:
%
%  
...
%                                   point is l/6
%
%   This function was written by Thomas Oswald, 2006
