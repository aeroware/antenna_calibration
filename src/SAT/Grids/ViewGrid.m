...
% nodes, segments or patches can be selected, which is 
% plotted red for emphasis. An initial control character is
% be used to indicate if objects, nodes, segments or patches 
...
% display all nodes, similarly for the other items. Objects are
% dispayed as their GraphProp fields determine, elements which 
...
% control characters (must be uppercase):
