...
function [Ant,NewObjs,NewSegs,NewPats]=GridUpdate(Ant0,Type,NewInd,Pack,FreeObjs)
...
% Type='Nodes+'. But carefull use is recommended as the 
...
% The optional arguments FreeObjs causes removal of the given objects if
