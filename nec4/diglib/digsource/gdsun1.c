...
static float characteristics[] = {  2.100,	/* device id */
...
static short cursor_data[16] = {
     ...
     mpr_static(sun1_cursor_image, 16, 16, 1, cursor_data);

     static struct cursor cross_hair_cursor = 
     {
        8, 8, PIX_SRC^PIX_DST, &sun1_cursor_image
     };
...
extern int sun1_init_device();	/* initialize device */
extern int sun1_clear_page();		/* screen clear */
extern int sun1_move_to();		/* absolute window coordinates */
extern int sun1_draw_to();		/* absolute window coordinates */
extern int sun1_flush();		/* flush all pending buffers */
extern int sun1_release_device();	/* close the sun window */
extern int sun1_return_device();	/* return device characteristics */
extern int sun1_select_color();	/* set the current forground color */
extern int sun1_get_input();		/* get input, null routine */
extern int sun1_set_color_map_rgb();	/* set up a rgb color look up table */
extern int sun1_set_color_map_hls();	/* set up a hls color look up table */
extern int sun1_button_input();	/* a routine to handle button input */
extern int sun1_draw_polygon();	/* draw a closed polygon */



gdsun1_( op_code, x_data, y_data )
                      ...
                      (* y_data)[]; /* y coordinate data */
{
   ...
   static int (* jump_table[MAX_OPCODE])() = {
                 ...
                 sun1_select_color,
                 sun1_get_input,
                 sun1_set_color_map_rgb,
                 sun1_set_color_map_hls,
                 sun1_button_input,
                 sun1_draw_polygon };
...
sun1_init_device( op_code, x_data, y_data )
...
float (* x_data)[], (* y_data)[];
{
   if ( gfx == NULL )		/* if first time thru the init device */
   {
      ...
      {
         signal( SIGWINCH, sun1_catch_signal );
...
sun1_clear_page( op_code,  x_data, y_data )
...
sun1_move_to( op_code, x_data, y_data )
...
sun1_draw_to( op_code, x_data, y_data )
...
sun1_flush( op_code, x_data, y_data )
...
sun1_release_device( op_code, x_data, y_data )
...
sun1_return_device( op_code, x_data, y_data )
...
sun1_select_color( op_code, x_data, y_data )
...
sun1_check_input(  gfx,  ibits,  obits,  ebits,   timer )
...
sun1_get_input( op_code, x_data, y_data )
...
sun1_set_color_map_rgb( op_code, x_data, y_data )
...
sun1_set_color_map_hls( op_code, x_data, y_data )
...
sun1_button_input( op_code, x_data, y_data )
...
sun1_draw_polygon( op_code, x_data, y_data )
